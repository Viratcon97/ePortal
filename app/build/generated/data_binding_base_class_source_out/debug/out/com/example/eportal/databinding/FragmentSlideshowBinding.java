...
public final class FragmentSlideshowBinding implements ViewBinding {
  ...
  private FragmentSlideshowBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAdd,
      @NonNull TextView textNoData, @NonNull RecyclerView userList) {
  ...
  public static FragmentSlideshowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSlideshowBinding((ConstraintLayout) rootView, btnAdd, textNoData,
          userList);
    }
