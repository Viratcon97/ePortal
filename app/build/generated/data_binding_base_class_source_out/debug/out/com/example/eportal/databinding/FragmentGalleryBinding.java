...
public final class FragmentGalleryBinding implements ViewBinding {
  ...
  private FragmentGalleryBinding(@NonNull ConstraintLayout rootView, @NonNull ListView listView) {
  ...
  public static FragmentGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGalleryBinding((ConstraintLayout) rootView, listView);
    }
